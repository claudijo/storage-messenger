...
var Server = require('selenium-webdriver/lib/test/httpserver').Server,
  ...
  // MODIFIED: Use custom resources
  resources = require('./resources'),

  promise = require('selenium-webdriver').promise,
  isDevMode = require('selenium-webdriver/_base').isDevMode(),
...
var Pages = (function() {
  ...
  addPage('shoutbox', 'test/integration/data/shoutbox.html');
  addPage('empty', 'test/integration/data/empty.html');
